...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Trang chủ | Bảng quản trị</title>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics">Danh sách danh mục</p>
...
<a href="manage-subcategories.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Danh sách danh mục phụ</p>
...
<?php include('includes/footer.php');?>
            ...
            <div class="side-bar right-bar">
                ...
                <div class="setting-list nicescroll">
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Quyền truy cập</h5>
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Trạng thái hoạt động</h5>
                            <p class="m-b-0 text-muted"><small>Hiện thị trạng thái hoạt động của bạn cho tất cả</small></p>
                        </div>
                        <div class="col-xs-4 text-right">
                            <input type="checkbox" checked data-plugin="switchery" data-color="#7fc1fc" data-size="small"/>
                        </div>
