...
<html lang="en">
    <head>
        ...
        <title> News | Quản lí danh mục phụ</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Quản lí danh mục phụ</h4>
...
<td colspan="7" align="center"><h3 style="color:red">Không tìm thấy bản ghi nào</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Danh mục phụ đã xóa</h4>
