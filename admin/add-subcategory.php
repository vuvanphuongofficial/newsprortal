...
<html lang="en">
    <head>
        ...
        <title>Trang tin tức | Thêm danh mục phụ</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Thêm danh mục phụ</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Thêm danh mục phụ </b></h4>
                                    <hr />
...
<?php } ?>
    ...
    <div class="form-group">
                                                    <label class="col-md-2 control-label">Danh mục phụ</label>
                                                    <div class="col-md-10">
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Mô tả danh mục phụ</label>
	                                                <div class="col-md-10">
